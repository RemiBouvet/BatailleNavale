...
prog : Grille.o Outil.o TorpilleurDeplacer.o TorpilleurChoisir.o TorpilleurAttaquer.o jouer.o Placement_bateau.o Placement_obstacle.o afficher.o serveur.o main.o
	gcc -o prog $^ $(FLAG)
...
Placement_bateau.o: Placer/Placement_bateau.c grille/Struct.h grille/Outil.h Placer/Placement_bateau.h Placer/serveur.h
